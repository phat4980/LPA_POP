...
import type { Web2Client, Web2FinalArtifact, Web2Job } from "../services/Web2Client.js";
...
export type Web2ClientPort = Pick<Web2Client, "healthCheck" | "createUploadJob" | "waitForCompletion" | "downloadFinalPdf">;
...
export class RealAutomationWorkflow implements AutomationWorkflow {
  ...
  constructor(private readonly circleK: CircleKAutomationPort, private readonly web2Client: Web2ClientPort, private readonly listFile: string, private readonly outputDir: string) {}
